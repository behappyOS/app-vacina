...
public class Address {
    ...
    public static final String STRING_STREET = "string_street";
    public static final String STRING_NEIGHBORHOOD= "string_neighborhood";
    public static final String STRING_CITY = "string_city";
    public static final String STRING_STATE = "string_state";
